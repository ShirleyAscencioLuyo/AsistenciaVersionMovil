...
class _TeacherFormState extends State<TeacherForm> {
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  SizedBox(width: 16.0), // Espacio entre los menús
                  Expanded(
                    child: _buildDropdownField(
              ...
              ElevatedButton(
                onPressed: _isFormValid ? () => _saveTeacher(context) : null,
                child: Text('Guardar'),
              ),
            ],
          ),
  ...
  void _saveTeacher(BuildContext context) async {
    final Map<String, dynamic> teacherData = {
      ...
      "birthdate": _selectedBirthdate != null
          ...
          : null,
      "ubigeo": {"id": int.parse(_selectedUbigeo!['id'].toString())},
    ...
    final Uri uri = Uri.parse('http://192.168.1.47:8085/scavontime/teacher');
    ...
    if (response.statusCode == 201) {
      _showAlert('Datos del maestro guardados exitosamente', Colors.green);
      ...
      _showAlert(
          'Error al guardar datos del maestro. Código de estado: ${response.statusCode}',
          Colors.red);
    }
  }
}
